# This is my package filter-core
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/filter-core.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/filter-core)
...
```bash
php artisan vendor:publish --tag="filter-core-views"
```

## Usage

```php
$filterCore = new Ameax\FilterCore();
echo $filterCore->echoPhrase('Hello, Ameax!');
```
