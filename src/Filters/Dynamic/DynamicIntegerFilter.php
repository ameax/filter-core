...
/**
 * Dynamic INTEGER type filter with runtime-configurable properties.
 */
final class DynamicIntegerFilter extends Filter implements DynamicFilter
{
    ...
    /**
     * Create a dynamic integer filter.
     */
