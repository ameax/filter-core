...
/**
 * Dynamic BOOLEAN type filter with runtime-configurable properties.
 */
final class DynamicBooleanFilter extends Filter implements DynamicFilter
{
    ...
    /**
     * Create a dynamic boolean filter.
     */
